        ...
        <div className="w-full max-w-4xl text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4 sm:gap-6">
            ...
            {!loggedIn && (
              <Link
                href="/signin"
                className="flex items-center justify-center gap-2 bg-yellow-400 text-black px-8 py-3 rounded-full font-extrabold hover:scale-105 transition w-full sm:w-auto"
              >
                <LogIn size={18} />
                SIGN IN
              </Link>
