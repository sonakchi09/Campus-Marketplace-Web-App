...
export default function UploadProduct() {
  const [form, setForm] = useState({
    name: "", price: "", category: "", description: "", imagePreview: "",
  });
  ...
  function handleImage(e: any) {
    ...
    reader.onloadend = () => setForm({ ...form, imagePreview: reader.result as string });
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow p-8 flex flex-col gap-5">
            ...
            <div>
              ...
              <input name="name" placeholder="e.g. Engineering Textbook"
            ...
            <div>
              ...
              <input type="number" name="price" placeholder="e.g. 350"
                onChange={handleChange} required
                className="w-full border border-gray-300 rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-yellow-400"
              />
            </div>
            ...
            <button type="submit"
              className="bg-yellow-400 text-black font-extrabold py-3 rounded-full hover:scale-105 transition"
            >
              Submit for Review
            </button>
            ...
            <div className="bg-white rounded-2xl shadow overflow-hidden border-2 border-dashed border-yellow-400">
              ...
              <div className="p-5 flex flex-col gap-2">
                ...
                <p className="text-yellow-500 font-bold text-lg">
                  {form.price ? `₹${Number(form.price).toLocaleString()}` : <span className="text-gray-400 font-normal text-sm">Price...</span>}
                </p>
                {form.category && (
